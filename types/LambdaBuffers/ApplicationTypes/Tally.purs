...
instance Prelude.Eq TallyStateDatum where
  eq = (\x0 -> (\x1 -> Prelude.(&&) (Prelude.(&&) (Prelude.(&&) (Prelude.(==) ((Data.Newtype.unwrap x0).proposal) ((Data.Newtype.unwrap x1).proposal)) (Prelude.(==) ((Data.Newtype.unwrap x0).proposalEndTime) ((Data.Newtype.unwrap x1).proposalEndTime))) (Prelude.(==) ((Data.Newtype.unwrap x0).for) ((Data.Newtype.unwrap x1).for))) (Prelude.(==) ((Data.Newtype.unwrap x0).against) ((Data.Newtype.unwrap x1).against))))
  ...
  toData =
    ( \x0 -> Ctl.Internal.Types.PlutusData.List
        ( [ Ctl.Internal.ToData.toData ((Data.Newtype.unwrap x0).proposal)
          , Ctl.Internal.ToData.toData ((Data.Newtype.unwrap x0).proposalEndTime)
