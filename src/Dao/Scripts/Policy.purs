...
fungiblePolicy = pure $ PlutusMintingPolicy $ mkScript' Optimized.fungiblePolicy
...
upgradePolicy = pure $ PlutusMintingPolicy $ mkScript' Optimized.alwaysMints
...
voteNftPolicy = pure $ PlutusMintingPolicy $ mkScript' Optimized.voteNftPolicy
